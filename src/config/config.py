...
class Config:
    def __init__(self, root_dir, current_model, num_epoch=30, batch_size=32,
                 sequence_len=128, sentence_len=64, document_len=16,
        ...
        self.raw_data = os.path.join(self.data_dir, 'data_raw.json')
        ...
        self.pos_dict = os.path.join(self.data_dir, 'dict_pos.json')
        self.tag_dict = os.path.join(self.data_dir, 'dict_tag.json')
        ...
        # BERT
        self.bert_dir = os.path.join(self.root_dir, 'cased_L-12_H-768_A-12')
